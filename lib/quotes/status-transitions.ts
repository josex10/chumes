...
const ALLOWED_TRANSITIONS: Record<string, string[]> = {
  ...
  [QUOTE_STATUS.CUSTOMER_APPROVED]: [QUOTE_STATUS.PENDING_AVAILABILITY, QUOTE_STATUS.CONVERTED, QUOTE_STATUS.REJECTED],
  [QUOTE_STATUS.PENDING_AVAILABILITY]: [QUOTE_STATUS.CONVERTED],
...
export function getStatusActionLabel(statusCode: string): string {
  switch (statusCode) {
    ...
    case QUOTE_STATUS.CONVERTED: return "Convert to event";
